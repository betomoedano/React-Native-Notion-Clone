...
INSERT INTO "new_NotionFile" ("authorId", "content", "coverPhoto", "createdAt", "description", "icon", "id", "order", "parentFileId", "title", "type", "updatedAt") SELECT "authorId", "content", "coverPhoto", "createdAt", "description", "icon", "id", "order", "parentFileId", "title", "type", "updatedAt" FROM "NotionFile";
